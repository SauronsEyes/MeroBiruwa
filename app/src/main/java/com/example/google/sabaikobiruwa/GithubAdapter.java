...
public class GithubAdapter extends RecyclerView.Adapter<GithubAdapter.GithubViewHolder> {
    ...
    public void onBindViewHolder(@NonNull GithubViewHolder githubViewHolder, int i) {
        ...
        githubViewHolder.txtPrice.setText("Rs. " + item.getPrice());
        ...
        githubViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, item.getItemname()+" was clicked", Toast.LENGTH_SHORT).show();
                ...
                iAddress.setText("Address: "+item.getAddress());
                iSeller.setText("Seller: "+item.getSeller());
